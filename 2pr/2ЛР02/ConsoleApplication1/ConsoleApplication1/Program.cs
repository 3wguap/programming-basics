...
namespace ConsoleApplication1
{
    class Program
    {
        ...
        {
            Console.WriteLine("Лабораторная работа №2.Основы языка С#: Исключительные ситуации.");
                                    ...
                                    case "1":
                                        {
                                            try
                                            {
                                                ...
                                                ArrayVector vector1 = new ArrayVector(num1);
                                                ...
                                                ArrayVector vector2 = new ArrayVector(num2);
                                                ...
                                                Vectors.Sum(vector1, vector2).Print();
                                            }
                                            catch
                                            {
                                    ...
                                    case "3":
                                        {
                                            ...
                                            Console.WriteLine("Ваш вектор: ");
                                            vector.Print();
                                            Console.WriteLine("Длина вектора: ", Vectors.Norm(vector));
                                            Console.ReadKey();
                                            Console.Clear();
                                            break;
                                        }
